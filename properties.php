...
<body>
      ...
      <div class="row properties-box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
          <div class="item">
            ...
            <h6>$2.264.000</h6>
            <h4><a href="property-details.html">18 Old Street Delta</a></h4>
            <ul>
  ...
  <footer>
    <div class="container">
      <div class="col-lg-12">
        <p>Copyright © 2025 Delhi Hotel and Villa Co., Ltd. All rights reserved. 
        
        Design: <a rel="nofollow" href=" " target="_blank">Delta Hotel</a></p>
      </div>
    </div>
  </footer>
