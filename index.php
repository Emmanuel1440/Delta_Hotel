      ...
      <div class="row">
        <div class="col-lg-8 col-md-8">
          <ul class="info">
            ...
            <li><i class="fa fa-map"></i> Delta Hotel and Villa...where luxury is at it's best, FL 33160</li>
          </ul>
        </div>
    ...
    <div class="owl-carousel owl-banner">
      <div class="item item-1">
        <div class="header-text">
          <span class="category">Delta, <em>Home Sweet home</em></span>
      ...
      <div class="item item-2">
        <div class="header-text">
          ...
          <h2>Be Quick!<br>Get the Rooms and services in town</h2>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <div class="counter">
                  ...
                  <p class="count-text ">Awards<br>Won 2024</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <ul>
                        ...
                        <li>Fine dining restaurants and exclusive lounges</li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <ul>
                        ...
                        <li>Fully equipped kitchen with state-of-the-art appliances</li>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="item phone">
                ...
                <h6>+254-020-0340<br><span>Phone Number</span></h6>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="item email">
                <img src="assets/images/email-icon.png" alt="" style="max-width: 52px;">
                <h6>info@hotel.co<br><span>Business Email</span></h6>
              </div>
            </div>
          </div>
        </div>
